...
ARG VITE_API_URL
ARG VITE_SLACK_INSTALL_REDIRECT_URI

ENV VITE_SLACK_CLIENT_ID=$VITE_SLACK_CLIENT_ID
ENV VITE_SLACK_REDIRECT_URI=$VITE_SLACK_REDIRECT_URI
ENV VITE_API_URL=$VITE_API_URL
ENV VITE_SLACK_INSTALL_REDIRECT_URI=$VITE_SLACK_INSTALL_REDIRECT_URI
...
RUN echo "VITE_SLACK_CLIENT_ID=$VITE_SLACK_CLIENT_ID" > .env.production && \
    ...
    echo "VITE_SLACK_INSTALL_REDIRECT_URI=$VITE_SLACK_INSTALL_REDIRECT_URI" >> .env.production
