<template>
	...
	<div :class="[
      isSticky
		...
		<router-link v-if="role === 'admin' || role === 'manager'" :to="{name: 'overview-admin'}" v-slot="{ isExactActive }" class="rounded-full p-3 bg-white hover:bg-gray-100 transition duration-200 ease-in-out"
		...
		<router-link :to="{name: 'overview-member'}" v-slot="{ isExactActive }" class="rounded-full p-3 bg-white hover:bg-gray-100 transition duration-200 ease-in-out"
