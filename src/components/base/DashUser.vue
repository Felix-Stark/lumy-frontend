<template>
    <div class="flex items-center w-full p-4 bg-white rounded-full shadow-lg">
        ...
        <div :class="['px-4 py-2 rounded-full', avgSent === 'positive' ? 'bg-lumy-green' : avgSent === 'mixed' || 'neutral' ? 'bg-lumy-neutral-light' : 'bg-lumy-danger']">
