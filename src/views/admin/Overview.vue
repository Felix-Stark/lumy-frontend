<template>
  <header class="grid grid-cols-2 md:grid-cols-2 2xl:mx-8 w-full items-stretch gap-6 mt-8">
    <HeadCard :title="adminStore.teamSummary?.feedback_submitted_total" description="Total feedback submitted">
    ...
    <HeadCard :title="constructiveAverageRounded" description="Constructive feedback">
