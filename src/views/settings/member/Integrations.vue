<template>
    <div class="flex flex-col items-center gap-6 w-full min-h-[60vh] p-8 bg-white rounded-xl shadow-md">
        ...
        <div class="flex space-x-4 mt-6">
            ...
            <button v-else @click="triggerGoogle" class="flex items-center space-x-2 px-4 py-2 bg-lumy-green text-white text-sm rounded-lg hover:bg-lumy-darker transition">
                Connect
            </button>
        </div>
    </div>
